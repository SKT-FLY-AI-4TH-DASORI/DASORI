...
from provider.ml.response import Checked
from provider.ml.constants import base_url
from provider.ml.constants import CheckResult
...
def check(text):
    ...
    payload = {
        "passportKey": "3ff4974524c34f7835ea5d2c0cdc6ddce4c180d6",
        "color_blindness": "0",
        "q": text,
    }
...
def check(text):
    ...
    if len(text) > 500:
        return Checked(result=False)
    # payload 안에 있는 passportKey가 매일 바뀜!
    payload = {
        "passportKey": "671342fcd5c0ea16d151d2d356de5197d3aecb08",
        "color_blindness": "0",
        "q": text,
    }
